...
public class NoticeController extends BaseController {
    ...
    @ResponseBody
    @BussinessLog(value = "删除通知",key = "warehouseId",dict = Dict.DeleteDict)
    public Object delete(@RequestParam Integer warehouseId) {

        //缓存通知名称
        LogObjectHolder.me().set(ConstantFactory.me().getNoticeTitle(warehouseId));

        this.noticeMapper.deleteById(warehouseId);
